package com.microservice.core.recommendation.services;
...
import com.microservice.core.recommendation.persistence.RecommendationEntity;
import com.microservice.core.recommendation.persistence.RecommendationRepository;
...
public class RecommendationServiceImpl implements RecommendationService {
    ...
    public List<Recommendation> getRecommendations(int productId) {
        ...
        recommendationList.forEach(s->s.setServiceAddress(serviceUtil.getServiceAddress()));
